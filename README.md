...
## Table of Contents
- [**Section 03: Running Services with Docker**](#images-running-services-with-docker)
...
![](images/01-your-computer.jpg)
![](images/02-virtual-machine.jpg)
![](images/03-scale-virtual-machine.jpg)
```javascript
// event-bus/index.js
...
![](images/04-second-virtual-machine.jpg)
```javascript
// event-bus/index.js
app.post('/events', (req, res) => {
  const event = req.body;
...
![](images/05-docker-container.jpg)
...
![](images/06-kubernetes-cluster.jpg)
